...
public class TreeApp2 {
    ...
    public TreeApp2 () {
        ...
        System.out.println();
        System.out.println("printing out tree in order");
        someTree.inOrder(someTree.root);
        System.out.println();
        System.out.println("deleting root of 50");
        System.out.println("Right child of root: " + someTree.root.rightChild.iData);
        System.out.println("Rigth left grandchild of root: " + someTree.root.rightChild.leftChild.iData);

        someTree.delete(50);
        someTree.inOrder(someTree.root);
        //System.out.println("Right child of root: " + someTree.root.rightChild.iData);
        System.out.println("So, by deleting the root, we have lost the value of 50 & the value of 80");
        System.out.println("Root is: " + someTree.root.iData);
        someTree.inOrder(someTree.root);
        System.out.println("Right child of root : " + someTree.root.rightChild.iData);
        someTree.delete(someTree.root.iData);
        System.out.println("root: " + someTree.root.iData);
        someTree.inOrder(someTree.root);
        someTree.insert(400,1.33);
        someTree.insert(4005,3.214);
        someTree.inOrder(someTree.root);
        System.out.println("root: " + someTree.root.iData);
        someTree.delete(5);
        someTree.delete(25);
        someTree.inOrder(someTree.root);
        someTree.insert(33,33.22);
        someTree.inOrder(someTree.root);
        someTree.delete(12);
        someTree.inOrder(someTree.root);
        someTree.delete(someTree.root.iData);
        ...
        // aha! we have an issue here. when there is no right subtree and we delete the root...root is reassigned to left node,
        // not the negative successor
        // we did it ! no more nodes.
